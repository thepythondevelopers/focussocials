...
export class DashboardComponent implements OnInit{
  ...
  nfs_30(){
    ...
    t_following(){
      ...
      let headers = new HttpHeaders()
    .set("Authorization",`bearer ${localStorage.getItem('token')}`);
      this.http.post(environment.baseURL+'/get_following',request,{headers}).subscribe((resp:any)=>{
    ...
    .set("Authorization",`bearer ${localStorage.getItem('token')}`);
        ...
        let headers = new HttpHeaders()
    .set("Authorization",`bearer ${localStorage.getItem('token')}`);
        this.http.post(environment.baseURL+'/save_following_month_p',{"id":request.id,"following_previous_month":this.new_following_month_pr},{headers}).subscribe((response:any)=>{
